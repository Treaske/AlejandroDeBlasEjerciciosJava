...
public class Mapper {
    ...
    public static OutputDTO mapInputToOutput(InputDTO inputDTO) {
        ...
        OutputDTO outputToInput = new OutputDTO();

        outputToInput.setFullName(inputDTO.getName());
        outputToInput.setJobTitle(inputDTO.getOccupation());
        outputToInput.setYearsOld(inputDTO.getAge());
